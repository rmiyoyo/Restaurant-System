...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/style.css */ \"./src/styles/style.css\");\n/* harmony import */ var _styles_mystyle_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/mystyle.css */ \"./src/styles/mystyle.css\");\n/* harmony import */ var _module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/mealDetails.js */ \"./src/module/mealDetails.js\");\n/* harmony import */ var _module_popup_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/popup.js */ \"./src/module/popup.js\");\n\n\n\n\n\n\nconst foodDescr = await (0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.fetchFoodInfo)();\nconst metricsInfo = await (0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.fetchInfo)();\n\n(0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.enterMeals)(foodDescr);\nfoodDescr.forEach((element) => {\n  (0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.showInfo)(metricsInfo, `M${element.idMeal}`);\n});\n\nconst comment = [...document.querySelectorAll('.comment')];\nconst popWindow = document.getElementById('my-popup-window');\n\nconst mealArea = document.querySelector('.menu');\nmealArea.addEventListener('click', async (e) => {\n  e.preventDefault();\n  if (e.target && e.target.matches('i.heart')) {\n    const uniqueID = e.target.id;\n    await (0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.oneLike)(uniqueID);\n    const metricsInfo = await (0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.fetchInfo)();\n    (0,_module_mealDetails_js__WEBPACK_IMPORTED_MODULE_2__.showInfo)(metricsInfo, uniqueID);\n  }\n});\nconst popupWindow = document.querySelector('.popup-window');\npopupWindow.addEventListener('click', (e) => {\n  if (e.target && e.target.matches('i.minimize-card')) {\n    popupWindow.innerHTML = '';\n  }\n});\n\ndocument.addEventListener('click', (e) => {\n  const { target } = e;\n  if (target.matches('.comment')) {\n    const { strMealThumb, strMeal } = foodDescr[comment.indexOf(target)];\n    popWindow.innerHTML = (0,_module_popup_js__WEBPACK_IMPORTED_MODULE_3__.showPopup)(strMealThumb, strMeal);\n    (0,_module_popup_js__WEBPACK_IMPORTED_MODULE_3__.togglePopup)();\n  } else if (target.matches('#close')) (0,_module_popup_js__WEBPACK_IMPORTED_MODULE_3__.togglePopup)();\n});\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } }, 1);\n\n//# sourceURL=webpack://Cooking_Masters/./src/index.js?");
